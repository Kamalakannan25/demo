...
package com.excel.service.persistence.impl;

import com.excel.exception.NoSuchPlayersException;
import com.excel.model.Players;
import com.excel.model.PlayersTable;
import com.excel.model.impl.PlayersImpl;
import com.excel.model.impl.PlayersModelImpl;
import com.excel.service.persistence.PlayersPersistence;
import com.excel.service.persistence.PlayersUtil;
import com.excel.service.persistence.impl.constants.excelPersistenceConstants;
...
public class PlayersPersistenceImpl
	...
	@Override
	@Reference(
		target = excelPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = excelPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)

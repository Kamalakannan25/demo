...
/**
 * Provides the local service utility for Vlog. This utility wraps
 * <code>com.exter.service.impl.VlogLocalServiceImpl</code> and
 ...
 * @generated
 */
public class VlogLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.exter.service.impl.VlogLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Vlog addVlog(Vlog vlog) {
		return getService().addVlog(vlog);
	}
	 ...
	 * @return the new vlog
	 */
	public static Vlog createVlog(long vlogId) {
		return getService().createVlog(vlogId);
	}
	 ...
	 */
	public static Vlog deleteVlog(long vlogId) throws PortalException {
		return getService().deleteVlog(vlogId);
	}
	 ...
	 * @return the vlog that was removed
	 */
	public static Vlog deleteVlog(Vlog vlog) {
		return getService().deleteVlog(vlog);
	}
	...
	public static Vlog fetchVlog(long vlogId) {
		return getService().fetchVlog(vlogId);
	}
	 ...
	 * @throws PortalException if a vlog with the primary key could not be found
	 */
	public static Vlog getVlog(long vlogId) throws PortalException {
		return getService().getVlog(vlogId);
	}
	 ...
	 */
	public static List<Vlog> getVlogs(int start, int end) {
		return getService().getVlogs(start, end);
	}
	 ...
	 */
	public static int getVlogsCount() {
		return getService().getVlogsCount();
	}
	 ...
	 */
	public static Vlog updateVlog(Vlog vlog) {
		return getService().updateVlog(vlog);
	}

	public static VlogLocalService getService() {
		return _service;
	}

	public static void setService(VlogLocalService service) {
		_service = service;
	}

	private static volatile VlogLocalService _service;

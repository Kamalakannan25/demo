 ...
 * <code>com.exter.service.impl.ApplicationLocalServiceImpl</code> and
...
public class ApplicationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.exter.service.impl.ApplicationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Application createApplication(long appId) {
		return getService().createApplication(appId);
	}
	 ...
	 */
	public static Application deleteApplication(long appId)
		throws PortalException {

		return getService().deleteApplication(appId);
	}
	...
	public static Application fetchApplication(long appId) {
		return getService().fetchApplication(appId);
	}
	 ...
	 * @throws PortalException if a application with the primary key could not be found
	 */
	public static Application getApplication(long appId)
		throws PortalException {

		return getService().getApplication(appId);
	}
	...
	public static void setService(ApplicationLocalService service) {
		_service = service;
	}

...
public interface ApplicationLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.exter.service.impl.ApplicationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the application local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ApplicationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Application createApplication(long appId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Application deleteApplication(long appId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Application fetchApplication(long appId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Application getApplication(long appId) throws PortalException;

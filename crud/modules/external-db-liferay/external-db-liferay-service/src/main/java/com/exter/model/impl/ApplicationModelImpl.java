...
import com.exter.model.ApplicationModel;
...
public class ApplicationModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table application (uuid_ VARCHAR(75) null,appId LONG not null primary key,appName VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table application";

	public static final String ORDER_BY_JPQL =
		" ORDER BY application.appId ASC";

	public static final String ORDER_BY_SQL = " ORDER BY application.appId ASC";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			Map<String, Function<Application, Object>>
				attributeGetterFunctions =
					new LinkedHashMap<String, Function<Application, Object>>();

			attributeGetterFunctions.put("uuid", Application::getUuid);
			attributeGetterFunctions.put("appId", Application::getAppId);
			attributeGetterFunctions.put("appName", Application::getAppName);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"uuid", (BiConsumer<Application, String>)Application::setUuid);
			attributeSetterBiConsumers.put(
				"appId", (BiConsumer<Application, Long>)Application::setAppId);
			attributeSetterBiConsumers.put(
				"appName",
				(BiConsumer<Application, String>)Application::setAppName);
	...
	public Object clone() {
		...
		applicationImpl.setUuid(getUuid());
		applicationImpl.setAppId(getAppId());
	...
	public Application cloneWithOriginalValues() {
		...
		applicationImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		applicationImpl.setAppId(this.<Long>getColumnOriginalValue("appId"));
	...
	public CacheModel<Application> toCacheModel() {
		...
		applicationCacheModel.uuid = getUuid();

		String uuid = applicationCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			applicationCacheModel.uuid = null;
		}

		applicationCacheModel.appId = getAppId();
	...
	public <T> T getColumnValue(String columnName) {
		...
		Function<Application, Object> function =

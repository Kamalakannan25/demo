...
/**
 * The arguments resolver class for retrieving value from Application.
 *
...
@Component(
	property = {
		"class.name=com.exter.model.impl.ApplicationImpl",
		"table.name=application"
	},
	service = ArgumentsResolver.class
)
public class ApplicationModelArgumentsResolver implements ArgumentsResolver {
	...
	public String getClassName() {
		return ApplicationImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return ApplicationTable.INSTANCE.getTableName();
	}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = applicationModelImpl.getColumnValue(columnName);
			}
		}

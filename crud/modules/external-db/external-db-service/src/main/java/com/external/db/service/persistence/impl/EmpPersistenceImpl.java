...
import com.external.db.service.persistence.EmpUtil;
...
public class EmpPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		EmpUtil.setPersistence(this);
	}

	public void destroy() {
		EmpUtil.setPersistence(null);

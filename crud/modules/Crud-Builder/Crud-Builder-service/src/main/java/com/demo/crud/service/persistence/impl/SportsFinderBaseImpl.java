 ...
 * @generated
 */
public abstract class SportsFinderBaseImpl extends BasePersistenceImpl<Sports> {

	public SportsFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return sportsPersistence.getBadColumnNames();
	}

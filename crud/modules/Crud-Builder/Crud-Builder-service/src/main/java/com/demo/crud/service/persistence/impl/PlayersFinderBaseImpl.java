 ...
 * @generated
 */
public abstract class PlayersFinderBaseImpl
	extends BasePersistenceImpl<Players> {

	public PlayersFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return playersPersistence.getBadColumnNames();
	}

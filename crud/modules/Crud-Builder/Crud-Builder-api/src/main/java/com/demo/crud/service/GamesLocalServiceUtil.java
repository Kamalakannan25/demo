...
/**
 * Provides the local service utility for Games. This utility wraps
 * <code>com.demo.crud.service.impl.GamesLocalServiceImpl</code> and
 ...
 * @generated
 */
public class GamesLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.demo.crud.service.impl.GamesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Games addGames(Games games) {
		return getService().addGames(games);
	}
	 ...
	 */
	public static Games createGames(long gamesId) {
		return getService().createGames(gamesId);
	}
	 ...
	 */
	public static Games deleteGames(Games games) {
		return getService().deleteGames(games);
	}
	 ...
	 */
	public static Games deleteGames(long gamesId) throws PortalException {
		return getService().deleteGames(gamesId);
	}
	...
	public static Games fetchGames(long gamesId) {
	 ...
	 */
	public static int getGamesesCount() {
		return getService().getGamesesCount();
	}
	 ...
	 */
	public static Games updateGames(Games games) {
		return getService().updateGames(games);
	}

	public static GamesLocalService getService() {
		return _service;
	}

	public static void setService(GamesLocalService service) {
		_service = service;
	}

	private static volatile GamesLocalService _service;
